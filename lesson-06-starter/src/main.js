...
// TODO: Create a new variable for the feature list element

// TODO: Add feature list to the displayed elements below
console.log('Selected elements:', {
  titleEl, taglineEl, heroImg, heroCaption, dynamicBox, footerNote,
});

// TODO: ====== Modify list content ======

// Add a new item dynamically

// Retreive all list items (querySelectorAll) and update their text

// Removing the first item from the list using DOM relationships to find it

// Update the second item using nextElementSibling

// Move the last item to the front of the list

// Use a timer to add a new item after 3 seconds have passed
